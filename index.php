                                ...
                                <form id="loginForm" action="backend/login.php" method="post">
                                    ...
                                    <div id="form-login">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nokp" placeholder="Masukkan No. Kad Pengenalan" required>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            ...
                                            <br>
                                            Tidak mempunyai akaun? <a href="register.php" style="color: black;">Daftar Akaun</a>
                                        </div>
                                    </div>
                                    <br>
